        ...
        <div class="listWrap">
          ...
          <div class="setSharedOption" :class="{active: modalShow == true}">
            ...
            <div>
                      ...
                      <div class="content">
                        ...
                        <div class="activityTypeBox">
                          ...
                          <div class="inp">
                            ...
                            <div>
                              <DropDown :optionName="selectData[10].select" :items="selectData[0].samplelist" dropdownId="d10" style="min-width: 80px;"></DropDown>
              ...
              <div class="optionFooter">
                <p class="notiTxt">학생들에게 제공될 배경화면은 발행사가 제공한 활동지를 선택해 사용하거나 선생님이 직접 제작한 이미지를 등록해 사용할 수 있어요.</p>
                <div class="btnWrap">
                  <button type="button" class="commonBtn"><span>저장</span></button>
                </div>
              </div>
