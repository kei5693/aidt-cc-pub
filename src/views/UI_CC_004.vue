      ...
      <div class="listWrap">
        ...
        <div class="listHeader">
          ...
          <div class="dataListTab">
            <div class="tabMenu">
              <button type="button" class="commonBtn buttonSizeL" @click="tabEvent(0)" :class="{primaryBg: currentIndex == 0,whiteGrayBg: currentIndex != 0 }"><span>LCMS</span></button>
              <button type="button" class="commonBtn buttonSizeL" @click="tabEvent(1)" :class="{primaryBg: currentIndex == 1,whiteGrayBg: currentIndex != 1 }"><span>문제은행</span></button>
            </div>
